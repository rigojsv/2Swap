...
return [
    ...
    | utilizados por la clase validadora. Algunas de estas reglas tienen versiones múltiples,
    ...
    */
    ...
    | sea rápido especificar una línea de lenguaje personalizada para una regla de atributo dada.
    |
    */
    ...
    | de "email". Esto simplemente nos ayuda a hacer que nuestros mensajes sean más expresivos.
    |
    */
