            ...
            @if($cart && $cart->items->count() > 0)
              ...
              <div class="card mb-4">
                <div class="card-body p-4 d-flex flex-row">
                  <div data-mdb-input-init class="form-outline flex-fill align-items-center d-flex">
                    <input type="text" id="form1" class="form-control form-control-lg" placeholder="Código de descuento" />
              ...
              <div class="card">
                <div class="card-body d-flex justify-content-between">
                  <a href="{{ route('cart.payment') }}" class="btn btn-success btn-block btn-lg">Proceder al pago</a>
                  <div>
