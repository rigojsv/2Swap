                    ...
                    @foreach($products as $product)
                        <div class="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
                            ...
                            <div class="mt-4">
                                ...
                                <p class="bg-red-100 text-red-600 border border-red-600 rounded-md py-2 px-4 font-bold mt-4 inline-block">
                                    Vendido
                                </p>
                                @else
                                    ...
                                    <div class="flex mt-4 space-x-2">
                                        ...
                                        <!-- Botón de eliminar -->
                                        <form action="{{ route('product.destroy', $product->id) }}" method="POST" class="flex items-center">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <a href="{{ route('product.edit', $product->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                            Editar
                                        </a>
                                    </div>
                                @endif
